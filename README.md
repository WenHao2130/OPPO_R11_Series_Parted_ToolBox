...
This is a Parted expansion kit for the OPPO R11 Series
### Program Main Menu
```
=================================================
...
- 03.只扩容System分区                     
- 04.同时扩容System与Vendor分区           
- 05.扩容System为5GB、Vendor分区为2GB     
- 06.还原原分区表                         
- 07.获取手机当前分区表数据               
...
- 08.TWRP自带格式化System分区(需要TWRP支持)
- 09.格式化System分区                    
- 10.TWRP自带格式化Vendor分区(需要TWRP支持)
- 11.格式化Vendor分区                    
- 12.通用格式化Data分区(需要TWRP支持)       
- 13.格式化Data分区_R11                  
- 14.格式化Data分区_R11s                
...
- 15.只扩容System分区                     
- 16.同时扩容System与Vendor分区           
- 17.扩容System为5GB、Vendor分区为2GB     
- 18.还原原分区表                         
...
```
128GB EMMC PartitionTreble
```
Model: MMC 3V6CMB (sd/mmc)
